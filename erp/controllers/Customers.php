...
class Customers extends MY_Controller
{
    ...
    function getCustomers()
    {
		...
		$this->datatables
            ->select("companies.id, companies.id as cid, (code) AS code, company, name, email, phone, customer_group_name, address, group_areas.areas_group as group_area, invoice_footer, (SELECT SUM(erp_deposits.amount) FROM erp_deposits WHERE erp_companies.id = erp_deposits.company_id) as deposit_amount, award_points, attachment")
            ->from("companies")
