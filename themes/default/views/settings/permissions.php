<?php // Before you add new permission should be translation about the word that you need addtion ?>
<style>
									   ...
									   <div class="container-fluid ">
											...
											<div class="col-md-6">
												<input type="checkbox" value="1" id="products-items_convert" class="checkbox"
													...
													for="products-items_convert" class="padding05"><?= lang('list_convert') ?></label>
											</div>
											<div class="col-md-6">
												<input type="checkbox" value="1" id="products-print_barcodes" class="checkbox"
													...
													for="products-print_barcodes" class="padding05"><?= lang('print_barcodes') ?></label>
											</div>
											<div class="col-md-6">
												<input type="checkbox" value="1" id="products-using_stock" class="checkbox"
													...
													for="products-using_stock" class="padding05"><?= lang('add_stock_using') ?></label>
											</div>
											<div class="col-md-6">
													<input type="checkbox" value="1" id="products-list_using_stock" class="checkbox"
														...
														for="products-list_using_stock" class="padding05"><?= lang('list_stock_using') ?></label>
											</div>
											<!-- <div class="col-md-6">
											...
											<div class="col-md-6">
													<input type="checkbox" value="1" id="products-import_quantity" class="checkbox"
														...
														for="products-import_quantity" class="padding05"><?= lang('update_quantity') ?></label>
											</div>
											<div class="col-md-6">
													<input type="checkbox" value="1" id="products-import_price_cost" class="checkbox"
														...
														for="products-import_price_cost" class="padding05"><?= lang('import_price_cost') ?></label>
											</div>
										<!--	<div class="col-md-6">
											...
											<div class="col-md-6">
													<input type="checkbox" value="1" id="products-count_stocks" class="checkbox"
														name="products-count_stocks" <?php echo $p->{'products-count_stocks'} ? "checked" : ''; ?>><label
														for="products-count_stocks" class="padding05"><?= lang('barcode_count_stock') ?></label>
											</div>
										...
										<div class="container-fluid">
											...
											<div class="col-md-4"> 
												<input type="checkbox" value="1" id="sale_order-combine_pdf" class="checkbox"
													...
													for="sale_order-combine_pdf" class="padding05"><?= lang('combine_to_pdf') ?></label>
											</div>
											<div class="col-md-4"> 
									    ...
									    <div class="container-fluid">
											...
											<div class="col-md-4">
													<input type="checkbox" value="1" id="sales-opening_ar" class="checkbox"
														...
														class="padding05"><?= lang('opening_ar') ?></label>
											</div>
											<!-- <div class="col-md-4">
											...
											<div class="col-md-4">
													<input type="checkbox" value="1" id="sales-combine_pdf" class="checkbox"
														...
														class="padding05"><?= lang('combine_to_pdf') ?></label>
											</div>
											<div class="col-md-4">
                                    ...
                                    <td>
                                        <div class="container-fluid" style="padding-left:30px;">
											...
											<input type="checkbox" value="1" id="quotes-conbine_pdf" class="checkbox"
												...
												for="quotes-conbine_pdf" class="padding05"><?= lang('combine_to_pdf') ?></label>
									     ...
									     <div class="container-fluid" >
											<div class="col-md-6">
													<input type="checkbox" value="1" id="purchases-expenses" class="checkbox"
														...
														for="purchases-expenses" class="padding05"><?= lang('list_expenses') ?></label>
											</div>
											...
											<div class="col-md-6">
													<input type="checkbox" value="1" id="purchases-add_expenses" class="checkbox"
														...
														for="purchases-add_expenses" class="padding05"><?= lang('add_expense') ?></label>
											</div>
											<div class="col-md-6">
											...
											<div class="col-md-6">
													<input type="checkbox" value="1" id="purchases-opening_ap" class="checkbox"
														...
														for="purchases-opening_ap" class="padding05"><?= lang('opening_ap') ?></label>
											</div>
											<div class="col-md-6">
													<input type="checkbox" value="1" id="purchases-opening_ap" class="checkbox"
														   name="purchases-import_expanse" <?php echo $p->{'purchases-import_expanse'} ? "checked" : ''; ?>><label
														for="purchases-import_expanse" class="padding05"><?= lang('import_expense') ?></label>
											</div>
											<div class="col-md-6">
											...
											<div class="col-md-6">
													<input type="checkbox" value="1" id="purchases-combine_pdf" class="checkbox"
														...
														for="purchases-combine_pdf" class="padding05"><?= lang('combine_to_pdf') ?></label>
											</div>
											<div class="col-md-6">
                                    ...
                                    <td>
									   <div class="container-fluid">
										 <div class="col-md-6">
											...
											for="account-list_receivable" class="padding05"><?= lang('list_ac_receivable') ?></label>
										</div>
										<div class="col-md-6">
											...
											for="account-list_ar_aging" class="padding05"><?= lang('list_ar_aging') ?></label>
										</div>
										<div class="col-md-6">
											...
											for="account-ar_by_customer" class="padding05"><?= lang('list_ar_aging') ?></label>
										</div>
										<div class="col-md-6">
											...
											for="account-bill_receipt" class="padding05"><?= lang('bill_receipt') ?></label>
										</div>
										<div class="col-md-6">
											...
											for="account-list_payable" class="padding05"><?= lang('list_payable') ?></label>
										</div>
										<div class="col-md-6">	
											...
											for="account-list_ap_aging" class="padding05"><?= lang('list_ap_aging') ?></label>
										</div>
										<div class="col-md-6">
											...
											for="account-ap_by_supplier" class="padding05"><?= lang('ap_by_supplier') ?></label>
										</div>
										<div class="col-md-6">
											...
											for="account-bill_payable" class="padding05"><?= lang('bill_payable') ?></label>
										</div>
										<div class="col-md-6">
											...
											for="account-list_ac_head" class="padding05"><?= lang('list_ac_head') ?></label>
										</div>
										<div class="col-md-6">									   
											...
											for="account-add_ac_head" class="padding05"><?= lang('add_ac_head') ?></label>
										</div>
										<div class="col-md-6">									  
											...
											for="account-list_customer_deposit" class="padding05"><?= lang('list_customer_deposit') ?></label>
										</div>
										<div class="col-md-6">
											...
											for="account-add_customer_deposit" class="padding05"><?= lang('add_customer_deposit') ?></label>
										</div>
										<div class="col-md-6">
											...
											for="account-list_supplier_deposit" class="padding05"><?= lang('list_supplier_deposit') ?></label>
										</div>
										<div class="col-md-6">
											...
											for="account-add_supplier_deposit" class="padding05"><?= lang('add_supplier_deposit') ?></label>
										</div>
										<div class="col-md-6">
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<input type="checkbox" value="1" id="transfers-combine_pdf" class="checkbox"
											...
											for="transfers-combine_pdf" class="padding05"><?= lang('combine_to_pdf') ?></label>
										</div>		
                                    </td>
                                </tr>
								  ...
								  <!-- Profit -->
                                        ...
                                        <div class="col-md-8" style="border-bottom: 2px solid #DDDDDD">
                                          <input type="checkbox" value="1" class="checkbox" id="report_profit-index"
                                            ...
                                            <label for="report_profit-index" class="padding05"><?= lang('profit_report') ?></label>
                                        </div><br/>
											...
											<div class="col-md-12">
											  <input type="checkbox" value="1" class="checkbox" id="report_profit-profit_andOr_lose"
												name="report_profit-profit_andOr_lose" <?php echo $p->{'report_profit-profit_andOr_lose'}? "checked" : '';?>>
												<label for="report_profit-profit_andOr_lose" class="padding05"><?= lang('profit_and_loss') ?></label><br/>
											  <input type="checkbox" value="1" class="checkbox" id="report_profit-payments"
												name="report_profit-payments" <?php echo $p->{'report_profit-payments'}? "checked" : '';?>>
												<label for="report_profit-payments" class="padding05"><?= lang('payments_report') ?></label><br/>
											  <input type="checkbox" value="1" class="checkbox" id="sale_report-register"
											   name="sale_report-register" <?php echo $p->{'sale_report-register'} ? "checked" : ''; ?>>
											   	<label for="sale_report-register" class="padding05"><?= lang('register_report') ?></label><br/>
											</div>
                                  ...
                                  <div class="col-md-4">                                    
                                    <div class="col-md-8" style="border-bottom: 2px solid #DDDDDD">
										<input type="checkbox" value="1" class="checkbox" id="products"
												...
												for="product_report-index" class="padding05"><?= lang('product_report') ?></label>
                                    </div><br/>
                                    <div class="col-md-12">
                                        ...
                                        for="product_report-in_out" class="padding05"><?= lang('products_in_out') ?></label><br/>
                                        ...
                                        for="product_report-monthly" class="padding05"><?= lang('monthly_product') ?></label><br/>
                                        ...
                                        for="product_report-daily" class="padding05"><?= lang('daily_product') ?></label><br/>
                                        ...
                                        for="product_report-categories" class="padding05"><?= lang('categories_report') ?></label><br/>
                                        ...
                                        for="product_report-categories_value" class="padding05"><?= lang('categories_value_report') ?></label><br/>
                                        ...
                                        for="product_report-inventory_valuation_detail" class="padding05"><?= lang('inventory_valuation_detail') ?></label><br/>
                                        ...
                                        for="product_report-suppliers" class="padding05"><?= lang('supplier_products') ?></label><br/>
                                        ...
                                        for="product_report-customers" class="padding05"><?= lang('product_customers') ?></label><br/>
                                        ...
                                        for="report_transfers" class="padding05"><?= lang('transfers_report') ?></label><br/>
                                        ...
                                        for="report_list_using_stock" class="padding05"><?= lang('list_using_stock_report') ?></label><br/>
										
										<input type="checkbox" value="1" class="checkbox" id="report_convert"
                                           name="report_convert" <?php echo $p->{'report_convert'} ? "checked" : ''; ?>><label
                                        for="report_convert" class="padding05"><?= lang('convert_report') ?></label><br/>										
                                        <input type="checkbox" value="1" class="checkbox" id="reports-product_top_sale"
                                           name="reports-product_top_sale" <?php echo $p->{'reports-product_top_sale'} ? "checked" : ''; ?>><label
                                        for="reports-product_top_sale" class="padding05"><?= lang('product_sale_top') ?></label><br/>
                                  </div>
                                  </div>
                                  ...
                                  <div class="col-md-4">
                                    <div class="col-md-8" style="border-bottom: 2px solid #DDDDDD">
                                      <input type="checkbox" value="1" class="checkbox" id="sale_report-index" name="sale_report-index" <?php echo $p->{'sale_report-index'} ? "checked" : ''; ?>><label
                                            for="sale_report-index" class="padding05"><?= lang('sale_report') ?></label>
                                    </div><br/>
                                    <div class="col-md-12">
										...
										<input type="checkbox" value="1" class="checkbox" id="sale_report-report_sale"
												...
												for="sale_report-sale_report" class="padding05"><?= lang('sales_report') ?></label><br/>
										<input type="checkbox" value="1" class="checkbox" id="sale_report-detail"
												...
												for="sale_report-detail" class="padding05"><?= lang('sales_detail_report') ?></label><br/>  
										<input type="checkbox" value="1" class="checkbox" id="sale_report-sale_profit"
												...
												for="sale_report-sale_profit" class="padding05"><?= lang('sales_profit_report') ?></label><br/>
									    <input type="checkbox" value="1" class="checkbox" id="sale_report-daily"
												...
												for="sale_report-daily" class="padding05"><?= lang('daily_sales') ?></label><br/>
										<input type="checkbox" value="1" class="checkbox" id="sale_report-monthly"
												...
												for="sale_report-monthly" class="padding05"><?= lang('monthly_sales') ?></label><br/>
										<input type="checkbox" value="1" class="checkbox" id="sale_report-disccount"
												...
												for="sale_report-disccount" class="padding05"><?= lang('sales_discount_report') ?></label><br/>
										<input type="checkbox" value="1" class="checkbox" id="sale_report-by_delivery_person"
												...
												for="sale_report-by_delivery_person" class="padding05"><?= lang('sale_by_delivery_person') ?></label><br/>
										...
										<input type="checkbox" value="1" class="checkbox" id="sale_report-delivery_detail"
												...
												for="sale_report-delivery_detail" class="padding05"><?= lang('sales_delivery_detail') ?></label><br/>
										...
										<!-- <input type="checkbox" value="1" class="checkbox" id="sale_report-room_table"
												...
												for="sale_report-room_table" class="padding05"><?= lang('suspend_report') ?></label><br/>
										-->
										<input type="checkbox" value="1" class="checkbox" id="sale_report-customer"
												...
												for="sale_report-customer" class="padding05"><?= lang('customers_report') ?></label><br/> 
										<!--
										<input type="checkbox" value="1" class="checkbox" id="sale_report-customer"
										...
										<input type="checkbox" value="1" class="checkbox" id="sale_report-saleman"
												...
												for="sale_report-saleman" class="padding05"><?= lang('saleman_report') ?></label><br/>

										<input type="checkbox" value="1" class="checkbox" id="sale_report-saleman_detail"
												   name="sale_report-saleman_detail" <?php echo $p->{'sale_report-saleman_detail'} ? "checked" : ''; ?>><label
												for="sale_report-saleman_detail" class="padding05"><?= lang('saleman_detail_report') ?></label><br/> 
                                ...
                                <!--  <div class="col-md-4">
                                    <div class="col-md-8" style="border-bottom: 2px solid #DDDDDD">
                                      <input type="checkbox" value="1" class="checkbox" id="chart_report-index"
                                            ...
                                            <label for="chart_report-index" class="padding05"><?= lang('chart_report') ?></label>
                                    </div><br/>
                                    <div class="col-md-12">
									  ...
									  <div class="col-md-4">
                                          <div class="col-md-8" style="border-bottom: 2px solid #DDDDDD">
                                            <input type="checkbox" value="1" class="checkbox" id="purchase_report-index"
                                                  ...
                                                  for="purchase_report-index" class="padding05"><?= lang('purchases_report') ?></label>
                                          </div><br/>
                                          <div class="col-md-12">
											<input type="checkbox" value="1" class="checkbox" id="purchase_report-purchas"
                                                  ...
                                                  for="purchase_report-purchas" class="padding05"><?= lang('purchases_report') ?></label><br/>
                                            <input type="checkbox" value="1" class="checkbox" id="purchase_report-daily"
                                                  ...
                                                  for="purchase_report-daily" class="padding05"><?= lang('daily_purchases') ?></label><br/>
                                            <input type="checkbox" value="1" class="checkbox" id="purchase_report-monthly"
                                                  ...
                                                  for="purchase_report-monthly" class="padding05"><?= lang('monthly_purchases') ?></label><br/>
												  <!--
										    ...
										    <input type="checkbox" value="1" class="checkbox" id="purchase_report-supplier"
                                                  ...
                                                  for="purchase_report-supplier" class="padding05"><?= lang('suppliers_report') ?></label><br/>
                                      ...
                                      <div class="col-md-4"> 
                                        <div class="col-md-8" style="border-bottom: 2px solid #DDDDDD">                                         
                                          <input type="checkbox" value="1" class="checkbox" id="account_report-index"
                                              ...
                                              <label for="account_report-index" class="padding05"><?= lang('ac_report') ?></label>
                                        </div><br/>
                                        ...
                                        <div class="col-md-12">
											...
											<input type="checkbox" value="1" class="checkbox" id="account_report-ledger"
												...
												<label for="account_report-ledger" class="padding05"><?= lang('ledger') ?></label><br/>
											<input type="checkbox" value="1" class="checkbox" id="account_report-trail_balance"
												...
												<label for="account_report-trail_balance" class="padding05"><?= lang('trial_balance') ?></label><br/>
											<input type="checkbox" value="1" class="checkbox" id="balance_sheet"
												...
												<label for="account_report-balance_sheet" class="padding05"><?= lang('balance_sheet') ?></label><br/>	  
											<input type="checkbox" value="1" class="checkbox" id="account_report-income_statement"
												...
												<label for="account_report-income_statement" class="padding05"><?= lang('income_statement') ?></label><br/>
											...
											<input type="checkbox" value="1" class="checkbox" id="account_report-income_statement_detail"
												...
												<label for="account_report-income_statement_detail" class="padding05"><?= lang('income_statement_detail') ?></label><br/>
											<input type="checkbox" value="1" class="checkbox" id="account_report-cash_book"
												...
												<label for="account_report-cash_book" class="padding05"><?= lang('cash_book') ?></label><br/>
