    ...
    <div class="col-xs-12" style="padding: 0">
        ...
        ?>
            ...
            <div class="row" style="text-align: left;">
                <div class="col-sm-7 col-xs-7" style="font-size: 12px; ">
                    <table >
                        <?php

                        if(!empty($customer->company)) { ?>
                            <tr>
                                <td style="width: 50%;">ក្រុមហ៊ុន​​​​​​ / Company</td>
                                <td style="width: 5%;">:</td>
                ...
                <div class="col-sm-5 col-xs-5" style="font-size: 12px; padding-left: 70px !important; " >
                    ...
                    <table class="table table-bordered" style=" white-space: nowrap;width: 100%; margin-top: 10px;">
                        <tbody style="font-size: 14px;">
                            <tr class="border thead print" style="text-align: center; white-space: nowrap;background-color: #444 !important; color: #FFF !important;">
								...
								<th style="width: 50px;text-align: center;">តម្លៃ<br />Unit Price</th>
