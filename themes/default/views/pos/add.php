                    					...
                    					<div class="btn-group">
                                            <div class="btn-group btn-group-justified">
                                                <div class="btn-group">
                                                    ...
                                                    <button type="button" title="Print Bill - <?= $pos_settings->print_bill ?>" class="btn btn-primary" id="print_bill"  style="margin-left: 0 !important;width:100%;">
                                                        <i class="fa fa-print"></i> <?= lang('print_bill'); ?>
                                                    </button>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data === false) {
							...
							console.log(amount1 +'='+ amount2 +'='+ amount +'='+ data.dep_amount );
