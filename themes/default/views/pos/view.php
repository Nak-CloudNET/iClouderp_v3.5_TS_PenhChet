            ...
            if ($pos_paidd < $inv->grand_total) {
                ...
                if(count($payments) > 1){
                    ...
                    if((($pay + ($pay_kh / (($pos_settings->in_out_rate) ? $outexchange_rate->rate:$exchange_rate->rate))) - $inv->grand_total) != 0){
                        ?>
                        <tr>
                            <th style="border-top:2px dotted #000;padding-right: 0px;" colspan="<?= $colspan ?>" class="text-right"><?= lang("remaining_us"); ?></th>
                            <th style="border-top:2px dotted #000" class="text-right">
                                <?php
                        ...
                        <tr>
                            <th style="border-top:2px dotted #000;padding-right: 0px;" colspan="<?= $colspan ?>" class="text-right"><?= lang("remaining_kh"); ?></th>
