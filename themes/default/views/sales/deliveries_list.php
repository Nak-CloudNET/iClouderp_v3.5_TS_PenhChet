...
<script>
    $(document).ready(function () {
        var oTable = $('#DOData').dataTable({
            ...
            {column_number: 6, filter_default_label: "[<?=lang('driver');?>]", filter_type: "text", data: []},
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-truck"></i><?= lang('Delivery_List'); ?></h2>
            ...
            <div class="col-lg-12">
                ...
                <table id="DOData" class="table table-bordered table-hover table-striped table-condensed ">
                    ...
                    <tr>
						...
						<th><?php echo $this->lang->line("quantity_delivery"); ?></th>
...
<?php if ($Owner) { ?>
    ...
    <script type="text/javascript" charset="utf-8">
        $(document).ready(function() {
			...
			$('body').on('click', '#completed_delivery', function(e) {
				e.preventDefault();
				$('#form_action').val($(this).attr('data-action'));
